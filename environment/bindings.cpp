...
PYBIND11_MODULE(agarcl, module) {
 ...
 py::class_<ScreenEnvironment>(module, "ScreenEnvironment")
  ...
  py::class_<agario::env::FoodInfo>(module, "FoodInfo")
      ...
      .def("get_position_x", [](const agario::env::FoodInfo &f) { return static_cast<float>(f.position.x); })
      .def("get_position_y", [](const agario::env::FoodInfo &f) { return static_cast<float>(f.position.y); })
  ...
  py::class_<agario::env::VirusInfo>(module, "VirusInfo")
      ...
      .def("get_position_x", [](const agario::env::VirusInfo &f) { return static_cast<float>(f.position.x); })
      .def("get_position_y", [](const agario::env::VirusInfo &f) { return static_cast<float>(f.position.y); })
  ...
  py::class_<agario::env::SporeInfo>(module, "SporeInfo")
      ...
      .def("get_position_x", [](const agario::env::SporeInfo &f) { return static_cast<float>(f.position.x); })
      .def("get_position_y", [](const agario::env::SporeInfo &f) { return static_cast<float>(f.position.y); })
  ...
  py::class_<agario::env::CloneInfo>(module, "CloneInfo")
      ...
      .def("get_position_x", [](const agario::env::CloneInfo &f) { return static_cast<float>(f.position.x); })
      .def("get_position_y", [](const agario::env::CloneInfo &f) { return static_cast<float>(f.position.y); })
  ...
  py::class_<GoBiggerEnv>(module, "GoBiggerEnvironment")
      .def(py::init<int, int, int, int, int, int, bool, int, int, int, bool, int, int, bool, bool>(),
          py::arg("map_width"),
          py::arg("map_height"),
          py::arg("frame_limit"),
          py::arg("num_agents"),
          ...
          py::arg("load_env_snapshot") = false,
